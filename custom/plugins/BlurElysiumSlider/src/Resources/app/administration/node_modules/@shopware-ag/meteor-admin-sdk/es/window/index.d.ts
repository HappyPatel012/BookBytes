...
export declare const getId: (messageOptions: import("../channel").MessageDataType<"windowGetId"> & import("../channel").BaseMessageOptions) => Promise<string>;
export declare const getPath: (messageOptions: import("../channel").MessageDataType<"windowRouterGetPath"> & import("../channel").BaseMessageOptions) => Promise<string>;
/**
