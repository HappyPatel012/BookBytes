export declare const open: (messageOptions: import("../../channel").MessageDataType<"uiMediaModalOpen"> & import("../../channel").BaseMessageOptions) => Promise<void>;
export declare const openSaveMedia: (messageOptions: import("../../channel").MessageDataType<"uiMediaModalOpenSaveMedia"> & import("../../channel").BaseMessageOptions) => Promise<void>;
