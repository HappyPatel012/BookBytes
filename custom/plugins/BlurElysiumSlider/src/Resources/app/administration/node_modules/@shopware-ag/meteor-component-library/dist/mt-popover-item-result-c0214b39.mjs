import './mt-popover-item-result.css';
import { defineComponent, resolveComponent, resolveDirective, openBlock, createElementBlock, createBlock, createCommentVNode, Fragment, renderList, createVNode, Transition, withCtx, createTextVNode, toDisplayString, TransitionGroup, withDirectives } from "vue";
import MtSearch from "./esm/MtSearch.js";
import mtPopoverItem from "./esm/MtPopoverItem.js";
import MtSmoothReflow from "./esm/MtSmoothReflow.js";
...
function startDrag(el, dragConfig, event) {
  if (dragConfig.validateDragStart !== null && !dragConfig.validateDragStart(dragConfig.data, el, event)) {
    return;
  }
  delayTimeout = null;
  if (currentDrag !== null) {
  ...
  const pageX = event instanceof MouseEvent && event.pageX || event instanceof TouchEvent && event.touches[0].pageX;
  const pageY = event instanceof MouseEvent && event.pageY || event instanceof TouchEvent && event.touches[0].pageY;
...
function calculateRotation(oldX, newX) {
  ...
  if (validDrag && currentDrag) {
    if (typeof currentDrag.dragConfig.onDrop === "function") {
      currentDrag.dragConfig.onDrop(
        ...
        validDrop ? (_a = currentDrop == null ? void 0 : currentDrop.dropConfig) == null ? void 0 : _a.data : null
      );
    }
  }
  if (validDrop && currentDrop) {
    if (typeof currentDrop.dropConfig.onDrop === "function") {
      currentDrop.dropConfig.onDrop(currentDrag == null ? void 0 : currentDrag.dragConfig.data, currentDrop.dropConfig.data);
    }
  }
...
function validateDrop() {
  ...
  if (currentDrag === null || currentDrop === null || currentDrop.dropConfig.dragGroup !== currentDrag.dragConfig.dragGroup) {
    valid = false;
  }
  if (currentDrag !== null && typeof currentDrag.dragConfig.validateDrop === "function") {
    customDragValidation = currentDrag.dragConfig.validateDrop(
      currentDrag.dragConfig.data,
      currentDrop == null ? void 0 : currentDrop.dropConfig.data
    );
  }
  if (currentDrop !== null && typeof currentDrop.dropConfig.validateDrop === "function") {
    customDropValidation = currentDrop.dropConfig.validateDrop(
      currentDrag == null ? void 0 : currentDrag.dragConfig.data,
      currentDrop.dropConfig.data
    );
  }
...
const droppable = {
  ...
  updated: (el, binding) => {
    ...
    if (binding.value instanceof Object) {
      Object.assign(dropZone == null ? void 0 : dropZone.dropConfig, binding.value);
    } else {
      Object.assign(dropZone == null ? void 0 : dropZone.dropConfig, { data: binding.value });
    }
  }
};
  ...
  setup(props, { emit }) {
    ...
    const dragConfig = {
      ...
      onDrop: (dragConfigData, dropConfigData) => {
        ...
        emit("change-order", {
          itemId: dragConfigData == null ? void 0 : dragConfigData.id,
          dropZone: dropConfigData == null ? void 0 : dropConfigData.dropZone,
          dropId: dropConfigData == null ? void 0 : dropConfigData.id
        });
      }
    };
    const isOptionDraggable = (option) => {
      return props.draggable && option.isSortable;
    };
    const getDragConfigForOption = (option) => {
      return {
        ...dragConfig,
...
const mtPopoverItemResult_vue_vue_type_style_index_0_lang = "";
const _hoisted_1 = { class: "mt-popover-item-result" };
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_mt_smooth_reflow = resolveComponent("mt-smooth-reflow");
  const _directive_droppable = resolveDirective("droppable");
  const _directive_draggable = resolveDirective("draggable");
  return openBlock(), createElementBlock("div", _hoisted_1, [
    !_ctx.hideSearch ? (openBlock(), createBlock(_component_mt_search, {
      key: 0,
      size: "small",
      "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => _ctx.$emit("search", $event))
    })) : createCommentVNode("", true),
    (openBlock(true), createElementBlock(Fragment, null, renderList([void 0, ..._ctx.groups], (group) => {
      return openBlock(), createElementBlock(Fragment, {
        key: "transition-group-" + (group && group.id)
      }, [
        createVNode(Transition, { name: "option-fade" }, {
          default: withCtx(() => [
            group && _ctx.getOptionsForGroup(group.id).length > 0 ? (openBlock(), createElementBlock("div", {
              key: group.id,
              class: "mt-popover-item-result__group-header",
              "aria-label": group.label
            }, [
              createVNode(_component_mt_text, {
                as: "span",
                size: "xs",
              ...
              group.actionLabel ? (openBlock(), createElementBlock("button", {
                key: 0,
                type: "button",
                class: "mt-popover-item-result__group-action",
                onClick: () => _ctx.$emit("click-group-action", group.id)
              }, toDisplayString(group.actionLabel), 9, _hoisted_3)) : createCommentVNode("", true)
            ], 8, _hoisted_2)) : createCommentVNode("", true)
          ]),
          _: 2
        }, 1024),
        createVNode(_component_mt_smooth_reflow, null, {
          default: withCtx(() => [
            createVNode(TransitionGroup, {
              ...
              default: withCtx(() => [
                (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.getOptionsForGroup(group && group.id), (option) => {
                  return openBlock(), createElementBlock("div", {
                    key: option.id,
                    class: "mt-popover-item-result__option",
                    "aria-label": (group && group.label ? group.label : "No group") + ": " + option.label
                  }, [
                    _ctx.isOptionDraggable(option) ? withDirectives((openBlock(), createElementBlock("div", _hoisted_5, null, 512)), [
                      [_directive_droppable, { ..._ctx.dropConfig, data: { ...option, dropZone: "before" } }]
                    ]) : createCommentVNode("", true),
                    withDirectives(createVNode(_component_mt_popover_item, {
                      class: "mt-popover-item-result__option_item",
                      "is-option-item": _ctx.isOptionDraggable(option),
                      label: option.label,
                      "show-checkbox": _ctx.selectable,
                      "checkbox-checked": option.isSelected,
                      "contextual-detail": option.contextualDetail,
                      "meta-copy": option.metaCopy,
                      "show-visibility": _ctx.hidable && option.isHidable,
                      visible: option.isVisible,
                      icon: _ctx.getIconForOption(option),
                      "on-label-click": option.isClickable ? () => _ctx.$emit("click-option", option.id) : void 0,
                      disabled: option.disabled,
                      onChangeCheckbox: ($event) => _ctx.$emit("change-checkbox", option.id, $event),
                      onChangeVisibility: ($event) => _ctx.$emit("change-visibility", option.id, $event)
                      ...
                      [_directive_draggable, { ..._ctx.getDragConfigForOption(option), data: option }]
                    ]),
                    _ctx.isOptionDraggable(option) ? withDirectives((openBlock(), createElementBlock("div", _hoisted_6, null, 512)), [
                      [_directive_droppable, { ..._ctx.dropConfig, data: { ...option, dropZone: "after" } }]
                    ]) : createCommentVNode("", true)
                  ], 8, _hoisted_4);
                }), 128))
              ]),
...
const MtPopoverItemResult = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  MtPopoverItemResult as M,
  droppable as a,
  draggable as d
};
//# sourceMappingURL=mt-popover-item-result-c0214b39.mjs.map
