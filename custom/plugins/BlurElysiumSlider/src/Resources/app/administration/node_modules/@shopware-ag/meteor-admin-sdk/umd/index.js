...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./window", "./notification", "./toast", "./context", "./ui/component-section", "./ui/tabs", "./ui/cms", "./location", "./ui/menu", "./ui/settings", "./ui/main-module", "./ui/module", "./ui/modal", "./ui/sidebar", "./ui/action-button", "./ui/media-modal", "./app/action", "./data", "./iap", "./data/composables"], factory);
    }
