...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./window", "./notification", "./toast", "./context", "./ui/component-section", "./ui/tabs", "./ui/cms", "./location", "./ui/menu", "./ui/settings", "./ui/main-module", "./ui/module", "./ui/modal", "./ui/sidebar", "./ui/action-button", "./ui/media-modal", "./app/action", "./data", "./iap", "./_private/payment", "./data/composables"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports._private = exports.iap = exports.composables = exports.data = exports.app = exports.location = exports.cms = exports.ui = exports.context = exports.toast = exports.notification = exports.window = void 0;
    ...
    const sidebar = __importStar(require("./ui/sidebar"));
    const actionButton = __importStar(require("./ui/action-button"));
    const mediaModal = __importStar(require("./ui/media-modal"));
    const webhook = __importStar(require("./app/action"));
    const data = __importStar(require("./data"));
    exports.data = data;
    const iap = __importStar(require("./iap"));
    exports.iap = iap;
    const payment = __importStar(require("./_private/payment"));
