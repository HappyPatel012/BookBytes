...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./function-serializer", "./criteria-serializer", "./entity-serializer", "./entity-collection-serializer", "./handle-error-serializer", "lodash-es/cloneDeepWith", "lodash-es/get", "lodash-es/set", "./missing-priviliges-error-serializer", "../utils"], factory);
    }
    ...
    const cloneDeepWith_1 = __importDefault(require("lodash-es/cloneDeepWith"));
    const get_1 = __importDefault(require("lodash-es/get"));
    const set_1 = __importDefault(require("lodash-es/set"));
    ...
    function mainSerializerFactory(dependencies) {
        ...
        function deserialize(messageData, event) {
            ...
            (0, utils_1.traverseObject)(desirialized, (_, key, value, previousKey) => {
                ...
                (0, set_1.default)(desirialized, reference, (0, get_1.default)(desirialized, path));
            });
            return desirialized;
        }
